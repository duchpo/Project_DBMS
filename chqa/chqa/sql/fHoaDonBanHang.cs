...
namespace sql
{
    public partial class fHoaDonBanHang : Form
    {
        ...
        {
            string sql;
            sql = "SELECT * From v_HoaDonView";
            tblCTHDB = Functions.GetDataToTable(sql); //lấy dữ liệu
            dgvHDBanHang.DataSource = tblCTHDB;
            dgvHDBanHang.Columns[0].HeaderText = "Mã hóa đơn";
            dgvHDBanHang.Columns[1].HeaderText = "Ngày mua";
            dgvHDBanHang.Columns[2].HeaderText = "Tên khách hàng";
            dgvHDBanHang.Columns[3].HeaderText = "Mã khách hàng";
            dgvHDBanHang.Columns[4].HeaderText = "Mã nhân viên";
            dgvHDBanHang.Columns[5].HeaderText = "Mã sản phẩm";
            dgvHDBanHang.Columns[6].HeaderText = "Số lượng";
            dgvHDBanHang.Columns[7].HeaderText = "Đơn giá";
            dgvHDBanHang.Columns[8].HeaderText = "Giá trị hóa đơn";

            dgvHDBanHang.AllowUserToAddRows = false;
            dgvHDBanHang.EditMode = DataGridViewEditMode.EditProgrammatically;
        }

        private void fHoaDonBanHang_Load(object sender, EventArgs e)
        {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    SqlCommand command = new SqlCommand("por_XoaHoaDon", Functions.Con);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@MaHD", txtMaHDBan.Text);
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("por_AddHoaDon", Functions.Con);
                cmd.CommandType = CommandType.StoredProcedure;

                // Thêm các tham số vào SqlCommand
                cmd.Parameters.AddWithValue("@MaHD", txtMaHDBan.Text.Trim());
                ...
                cmd.Parameters.AddWithValue("@MaKH", cboMaKhach.Text.Trim());
                cmd.Parameters.AddWithValue("@MaNV", cboMaNhanVien.Text.Trim());
                cmd.Parameters.AddWithValue("@DonGia", txtDonGia.Text.Trim());
                cmd.Parameters.AddWithValue("@TriGiaHD", txtThanhTien.Text.Trim());
...
/*            btnSua.Enabled = true;*/
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("proc_TimKiemHoaDon", Functions.Con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT * From v_HoaDonView WHERE MaHD = '" + txtMaHDBan.Text + "'";
            ...
            exRange.Range["C9:E9"].Value = tblThongtinHD.Rows[0][9].ToString();
            ...
            exRange.Range["C11:C11"].Value = "Ngày mua";
            exRange.Range["D11:D11"].Value = "Tên khách hàng";
            exRange.Range["E11:E11"].Value = "Mã khách hàng";
            ...
            exRange.Range["K11:K11"].Value = "SĐT";
        ...
        private void dgvHDBanHang_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0) // Đảm bảo chỉ lấy dữ liệu khi hàng được chọn
            {
                ...
                txtMaHDBan.Text = row.Cells["MaHD"].Value.ToString();
                cboMaNhanVien.Text = row.Cells["MaNV"].Value.ToString();
                cboMaKhach.Text = row.Cells["MaKH"].Value.ToString();
                ...
                txtThanhTien.Text = row.Cells["TriGiaHD"].Value.ToString();
