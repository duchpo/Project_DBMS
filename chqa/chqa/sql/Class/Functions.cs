...
namespace sql.Class
{
    internal class Functions
    {
        ...
        {
            ConAdmin = new SqlConnection();   //Khởi tạo đối tượng
            ConAdmin.ConnectionString = @"Data Source = QUOC-VIET; Initial Catalog = cuaHangQA; Integrated Security = True";
            ConAdmin.Open();                  //Mở kết nối
                                              //Kiểm tra kết nối
        ...
        public static void Connect(string u, string p)
        {
            ...
            Con.ConnectionString = @"Data Source=QUOC-VIET;Initial Catalog=cuaHangQA;User ID=" + u + ";Password=" + p;
            Con.Open();                  //Mở kết nối
                                         //Kiểm tra kết nối
